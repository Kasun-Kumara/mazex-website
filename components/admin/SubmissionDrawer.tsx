      ...
      {isOpen && (
        <div key="drawer-wrap" className="absolute inset-0 z-50 pointer-events-none">
          ...
          <motion.div
            ...
            className="absolute bottom-0 w-full z-[60] pointer-events-auto bg-white dark:bg-zinc-900 border-t border-zinc-200 dark:border-zinc-800 rounded-t-2xl shadow-[0_-20px_40px_-20px_rgba(0,0,0,0.1)] flex flex-col max-h-[85vh] overflow-hidden"
