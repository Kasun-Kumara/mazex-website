...
export default function FormSelectorDropdown({
  ...
  return (
    ...
    >
      <div className="relative w-full sm:w-auto sm:min-w-[280px]" ref={containerRef}>
        <button
          type="button"
            ...
            <div className="max-h-[300px] overflow-y-auto px-1.5">
              {items.map((item) => (
                <Link
                  ...
                  className={`flex flex-col gap-0.5 rounded-lg px-3 py-2.5 text-sm transition-all ${
                    item.id === selectedId
                ...
                >
                  ...
                  <span className="ml-5 text-[10px] font-bold uppercase tracking-wider opacity-60">
                    {item.kind}
                  </span>
                </Link>
              ))}
